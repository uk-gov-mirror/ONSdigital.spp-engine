...
def test_db_table_single_where():
    ...
    assert expected_query == str(Query("test", "test", where={"column": {"condition": "==", "value": "500"}}))
...
def test_db_table_single_select_where():
    ...
    assert expected_query == str(Query("test", "test", "column", {"column": {"condition": "=", "value": "test"}}))
